...
{
    public class PusherIntegrationPostModelValidator : AbstractValidator<PusherIntegrationPostModel>
    {
        public PusherIntegrationPostModelValidator(IValidator<KeyValuePair<string, string>> keyValuePairValidator)
        {
            RuleFor(x => x.Name)
                .MinimumLength(3)
                .MaximumLength(128)
